...
class ApiResponseParser:
    ...
    def timeline_of_sub_type(master_eo, sub_type):
        rel_ = [l for l in master_eo["timelines"] if
                l.get("type") == "http://id.nrk.no/2017/client/types/Timeline" and l.get("subType") == sub_type]
...
class MdbJsonApi(object):
    """
    Knows how to work with client-format hyperlinked json objects. Calls client in a responsible manner with
