...
def test_find_link():
    result = ApiResponseParser.timeline_of_sub_type(meo_testdata, "http://id.nrk.no/2017/mdb/timelinetype/Rights")
    ...
    assert res_id == "http://id.nrk.no/2017/mdb/timeline/966ccc52-a53f-4ef5-accc-52a53fbef777"
