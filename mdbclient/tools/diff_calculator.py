...
class Diff:
    ...
    def cleanup_autogenerated_resids(self, modification):
        self.__treat_collection(modification["subjects"])
        self.__treat_collection(modification["categories"])
        self.__treat_collection(modification["contributors"])
        self.__treat_collection(modification["spatials"])
